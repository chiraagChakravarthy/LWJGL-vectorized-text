...
import io.github.chiraagchakravarthy.lwjgl_vectorized_text.TextRenderer2;
...
public class TextRendererTest2 {
    ...
    private void render() {
        ...
        TextRenderer2 textRenderer = new TextRenderer2(font);
        ...
        do {
            ...
            for (int i = 0; i < 200; i++) {
                ...
                textRenderer.drawText(Math.random() + "", pose2, new Vector2f(0, 0), TextRenderer2.TextBoundType.BOUNDING_BOX, color);
            }

            textRenderer.render(mvp);
